<template>
  <div>
    ...
    <h1 class="welcome">SIGNUP</h1>
    <account-error-list v-if="authError" class="d-flex justify-content-center">
    </account-error-list>
    <!-- 사인업 폼 -->
    <div class="login-container d-flex justify-content-center" id="login-container">
      <form class="form-signin text-center" onsubmit="login(event)" 
            id="form-signin" @submit.prevent="signup(credentials)">
              ...
              <div class="mb-4">
                ...
                <div class="form-group form-group-2">
                  ...
                  <input type="password" style="background-color:black; color:white; border:solid 1px rgb(168, 168, 168); margin-bottom:5px;"
                        name="password"
                        id="password" 
                        class="form-control" placeholder="PASSWORD" v-model="credentials.password1" required>
                </div>
                ...
                <div class="form-group form-group-2">
                  ...
                  <input type="password" style="background-color:black; color:white; border:solid 1px rgb(168, 168, 168); margin-bottom:5px;"
                        name="password"
                        id="password" 
                        class="form-control" placeholder="PASSWORD CONFIRM" v-model="credentials.password2" required>
                </div>
              </div>
...
$border-radius: 4px;
$primary-color: blue;
$primary-color-light: lighten(rgb(168, 168, 168), 15%);
